...
const roadmapSteps = [
  ...
  },
  {
    year: "2030",
    tpd: "300 TPD",
    title: "Integrated Platform Scale",
      ...
      <div className="relative z-10 px-6 md:px-12 h-full flex flex-col justify-center">
        <div className="max-w-3xl mb-16">
          <h2 className="font-heading text-4xl md:text-5xl font-normal leading-tight mb-4">
            30 TPD Start.
            <br />
            <span className="italic text-verdaez-400">
              300 TPD Five-Year Scale Target.
            </span>
          </h2>
        ...
        <div className="w-full md:overflow-visible overflow-x-auto pb-8">
          <div
            ...
            className="flex gap-8 md:gap-12 w-max items-end"
          >
                ...
                <div className="glass-panel p-8 rounded-[24px] h-[320px] flex flex-col justify-between hover:bg-white/10 transition-colors duration-500 border-t border-t-white/20">
                  <div>
                    <div className="flex items-end justify-between mb-6">
                      <span className="text-4xl font-heading text-white font-light">
                        {step.year}
                      </span>
                  ...
                  {/* Subtle node marker */}
                  <div className="w-3 h-3 rounded-full bg-verdaez-400 shadow-[0_0_15px_rgba(140,166,101,0.6)] group-hover:scale-150 transition-transform duration-300" />
                </div>
              </div>
            ))}
          </div>
