...
const disciplines = [
  {
    ...
    desc: "Diverse, local and traceable biomass supply chains.",
  },
  {
    title: "Process Data",
    desc: "Data-driven operations and continuous improvement.",
  },
  {
    title: "Product Quality",
    desc: "Consistent specifications and third-party validation.",
  },
  {
    title: "EHS Excellence",
    desc: "Environment, health and safety as a core operating value.",
  },
  {
    title: "Strict Compliance",
    desc: "Regulatory adherence and transparent reporting.",
  },
  {
    title: "Procurement Discipline",
    desc: "Value, quality and total cost of ownership.",
  },
  {
    title: "Vendor Due Diligence",
    desc: "Qualified partners and performance track record.",
  },
  {
    title: "Installed References",
    desc: "Trusted equipment with proven installed performance.",
  },
  {
    title: "Feedstock Trials",
    desc: "Pilot trials before scale for process and product fit.",
  },
  {
    title: "Offtake Led Expansion",
    desc: "Demand visibility drives responsible capacity growth.",
  },
];
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32">
              ...
              <p className="font-body text-lg text-on-surface-variant leading-relaxed max-w-md">
                We believe climate businesses must be financially viable,
                operationally disciplined, and technically honest. Our
                engineering framework prioritizes risk mitigation at every step.
              </p>
