...
export default function PlatformRevenueEngine() {
  ...
  return (
    <section id="revenue" ref={containerRef} className="py-32 bg-surface-container-low border-t border-outline-variant/30 relative">
      {/* Soft atmospheric radial gradient for clean light background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[radial-gradient(circle_at_center,rgba(76,108,84,0.015)_0%,transparent_55%)] pointer-events-none" />
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-front border border-outline-variant/35 p-8 flex flex-col justify-between shadow-[0_10px_35px_rgba(0,0,0,0.02)] hover:border-surface-tint/50 bg-white">
                  ...
                  <div className="flex justify-between items-center border-t border-outline-variant/20 pt-4 mt-6">
                    <span className="text-[9px] font-body text-on-surface-variant/50 font-bold tracking-wider uppercase">Hover to Flip</span>
                ...
                <div className="flip-card-back bg-primary text-white p-8 flex flex-col justify-between shadow-ambient">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <span className="block text-[8px] uppercase tracking-widest text-white/50">MARGIN PROFILE</span>
                        <span className="font-heading text-xl text-verdaez-200">{stream.margin}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] uppercase tracking-widest text-white/50">PRIMARY BUYERS</span>
                        <span className="font-body text-xs text-white/90 leading-relaxed block mt-0.5">{stream.market}</span>
                      </div>
                      <div>
                        <span className="block text-[8px] uppercase tracking-widest text-white/50">CONTRACTUAL STRUCTURE</span>
                  ...
                  <div className="flex justify-between items-center border-t border-white/10 pt-4 text-xs font-body mt-6">
                    ...
                    <span className="text-verdaez-400 font-semibold font-heading text-sm">Verdaez</span>
                  </div>
                </div>
