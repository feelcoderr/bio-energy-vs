...
const trustPillars = [
  {
    ...
    subtitle: "Aligned with Verra Carbon Standards",
...
export default function PlatformGovernance() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-32 bg-surface-container-low border-b border-outline-variant/35 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="trust-reveal text-center mb-24 max-w-3xl mx-auto">
          ...
          <p className="font-body text-base md:text-lg text-on-surface-variant leading-relaxed">
            We hold ourselves to rigorous governance principles to guarantee
            that our products deliver authentic, permanent carbon removal and
            true circularity.
          </p>
        </div>
