        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <h2 className="cta-reveal font-heading text-4xl md:text-5xl lg:text-6xl text-primary font-normal leading-[1.1] mb-6">
              Build the Circular Carbon <br/>
              <span className="italic text-surface-tint">Economy Together.</span>
            </h2>
            <p className="cta-reveal font-body text-base md:text-lg text-on-surface-variant leading-relaxed max-w-lg mb-8">
              Partner with Verdaez to secure clean biocarbon supply contracts, establish local preprocessing facilities, or license modular blueprints.
            </p>
            ...
            <div className="cta-reveal flex flex-col sm:flex-row gap-4">
              ...
              <a href="mailto:info@verdaez.com" className="btn-secondary justify-center">
                Talk to our Team
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 bg-surface-container-low border border-outline-variant/35 rounded-[2.5rem] p-8 md:p-10 shadow-ambient-sm cta-reveal">
            ...
            {formSubmitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="font-heading text-2xl text-primary font-normal mb-2">Thank You</h3>
                <p className="font-body text-sm text-on-surface-variant leading-relaxed">
                  We have received your briefing request. An engineering strategist from our team will contact you shortly.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                <h3 className="font-heading text-2xl text-primary font-normal mb-6">Request Commercial Briefing</h3>
                
                <div>
                  <label htmlFor="name" className="block text-[10px] font-body font-bold text-on-surface-variant uppercase tracking-widest mb-1.5">Full Name</label>
                  <input 
                    type="text" 
                    id="name" 
                    required 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="email" className="block text-[10px] font-body font-bold text-on-surface-variant uppercase tracking-widest mb-1.5">Email Address</label>
                    <input 
                      type="email" 
                      id="email" 
                      required 
                  ...
                  <div>
                    <label htmlFor="org" className="block text-[10px] font-body font-bold text-on-surface-variant uppercase tracking-widest mb-1.5">Organization</label>
                    <input 
                      type="text" 
                      id="org" 
                      required 
                ...
                <div>
                  <label htmlFor="message" className="block text-[10px] font-body font-bold text-on-surface-variant uppercase tracking-widest mb-1.5">Project Scope / Message</label>
                  <textarea 
                    id="message" 
                    rows={4} 
                    required 
