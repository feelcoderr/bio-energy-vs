...
const industries = [
  {
    ...
    needs:
      "Drought resilience, soil degradation, fertilizer runoff prevention, and carbon farming incentives.",
    ...
    opportunity:
      "Estimated market value of $3.5B by 2030, driven by regenerative farming mandates.",
  },
  {
    id: "energy",
    ...
    needs:
      "Coal phase out mandates, soaring carbon taxes, and renewable thermal energy requirements.",
    ...
    opportunity:
      "Direct displacement of fossil coal in regional industrial centers.",
  },
  {
    id: "water",
    ...
    needs:
      "Strict clean water standards, municipal sewage treatment, and organic chemical filtration.",
    ...
    opportunity:
      "High-value specialty chemical market with recurring replacement demand.",
  },
  {
    id: "infrastructure",
    ...
    needs:
      "Low carbon concrete building materials, high strength additives, and green building certs.",
    ...
    opportunity:
      "Large scale procurement options with massive long term carbon volume storage.",
  },
  {
    id: "electronics",
    ...
    needs:
      "High capacity battery anodes, faster charging cycles, and synthetic graphite substitutes.",
    ...
    opportunity:
      "High-margin, high growth technology frontier serving the EV supply chain.",
  },
];
...
export default function PlatformMarkets() {
  ...
  return (
    <section
      id="markets"
      ref={containerRef}
      className="py-32 bg-surface-container-lowest border-t border-outline-variant/30 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="markets-reveal text-center mb-20">
          ...
          <p className="font-body text-base md:text-lg text-on-surface-variant max-w-2xl mx-auto leading-relaxed">
            Ratnanjali bioenergy feeds high value carbon products directly into
            global supply chains. Toggle the sectors below to discover
        ...
        <div className="markets-reveal grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-12">
          ...
          <div className="lg:col-span-8 bg-surface-container-low border border-outline-variant/35 rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 md:p-10 shadow-ambient-sm min-h-0 md:min-h-[360px] flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="market-content-inner space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-outline-variant/30 pt-8">
                ...
                <div className="space-y-6">
                  <div>
                    <span className="block text-[9px] font-body font-bold uppercase tracking-widest text-on-surface-variant/70 mb-1">
                      MARKET NEED
                    </span>
                  ...
                  <div>
                    <span className="block text-[9px] font-body font-bold uppercase tracking-widest text-on-surface-variant/70 mb-2">
                      RATNANJALI BIOENERGY PRODUCTS
                    </span>
                    <div className="flex flex-wrap gap-2">
                      {activeInd.products.map((prod) => (
                        <span
                          key={prod}
                          className="px-3.5 py-1.5 rounded-full border border-surface-tint/30 bg-white font-body text-[10px] font-semibold text-surface-tint"
                        >
                          {prod}
                        </span>
                      ))}
                ...
                {/* Applications list */}
                <div>
                  <span className="block text-[9px] font-body font-bold uppercase tracking-widest text-on-surface-variant/70 mb-3">
                    APPLICATIONS
                  </span>
            ...
            {/* <div className="mt-12 bg-white border border-outline-variant/40 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <span className="block text-[8px] font-body font-bold uppercase tracking-widest text-on-surface-variant/60">
                  SECTOR OPPORTUNITY
                </span>
                <p className="font-body text-xs text-on-surface mt-0.5">
                  {activeInd.opportunity}
                </p>
              </div>
