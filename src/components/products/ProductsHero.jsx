...
export default function ProductsHero() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-[85vh] overflow-hidden bg-primary flex items-center justify-center pt-24">
      {/* Background Image */}
      <div 
        ref={imageRef}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="hero-element font-body text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-10">
          At Verdaez, we transform sustainably sourced biomass into a diversified portfolio of renewable fuels, carbon-rich products, and advanced engineered materials.
        </p>
        
        <div className="hero-element flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#portfolio" className="btn-primary w-full sm:w-auto text-center">
            Explore Portfolio
          </a>
          <a href="#contact" className="px-8 py-4 rounded-full font-heading font-medium tracking-wide transition-all duration-300 border border-white/20 bg-white/5 text-white hover:bg-white/10 w-full sm:w-auto text-center">
            Request Catalogue
          </a>
        </div>
      </div>
