...
export default function ProductsFuture() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-32 bg-primary overflow-hidden border-t border-white/10"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <p className="future-text font-body text-lg md:text-xl text-white/80 leading-relaxed mb-12 max-w-3xl mx-auto">
          Our roadmap extends beyond today's renewable products. By combining
          industrial production with ongoing material research, Ratnanjali
          Bioenergy is building pathways toward advanced carbon technologies
          capable of serving future applications in clean energy, electronics,
