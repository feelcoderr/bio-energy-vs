...
const nodes = [
  {
    ...
    valueExchanged:
      "Ratnanjali Bioenergy pays stable, locked-in pricing for organic residue, creating secondary income and resolving farm residue disposal costs.",
  ...
  },
  {
    ...
    valueExchanged:
      "Ratnanjali Bioenergy coordinates geolocated routes to optimize residue collection within a 50km radius, boosting regional trucking jobs.",
  ...
  },
  {
    ...
    valueExchanged:
      "Preparing feedstocks for thermochemical cracking, validating quality parameters before delivery to main refinery.",
  ...
  },
  {
    ...
    valueExchanged:
      "Separating biomass into syngas (self-fueling), bio-oil (industrial fuels), and biochar matrices.",
  ...
  },
  {
    ...
    valueExchanged:
      "Off-takers buy renewable fuels to displace coal, or premium biochars to optimize crop yield.",
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M17 20h5-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"
        />
      </svg>
    ),
  },
...
export default function EcosystemValueChain() {
  ...
  return (
    <section
      id="value-chain"
      ref={containerRef}
      className="py-32 bg-white border-t border-outline-variant/30 relative"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="chain-reveal text-center mb-10">
          ...
          <p className="font-body text-base md:text-lg text-on-surface-variant max-w-2xl mx-auto leading-relaxed">
            Every participant creates and captures value in the circular loops.
            Click the nodes below to explore roles, values exchanged, and
            metrics.
          </p>
        </div>
            ...
            {nodes.map((node, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-14 h-14 rounded-full flex items-center justify-center border-2 bg-white transition-all duration-300 shadow-ambient-sm relative ${
                      isActive
                        ? "border-surface-tint text-primary scale-110 shadow-[0_0_20px_rgba(100,128,50,0.15)]"
                        : isPassed
                  ...
                  <span
                    className={`font-heading text-xs mt-3 text-center transition-colors duration-300 ${
                      isActive
