...
export default function EcosystemIntentSelector() {
  ...
  const [activeTab, setActiveTab] = useState(
    roleParam === "partner" ? "partner" : "investor",
  );
  ...
  return (
    <section
      id="intent"
      ref={containerRef}
      className="py-24 bg-surface-container-low border-t border-outline-variant/30"
    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                <div className="lg:col-span-7 bg-white border border-outline-variant/30 rounded-[2.5rem] p-10 shadow-ambient-sm">
                  ...
                  <h3 className="font-heading text-3xl text-primary font-normal mb-6">
                    The Ratnanjali Bioenergy Investment Thesis
                  </h3>
                  <p className="font-body text-sm text-on-surface-variant leading-relaxed mb-6">
                    Bioenergy projects often fail due to volatile logistics or
                    single-product market reliance. Ratnanjali Bioenergy
                    mitigates this through low-capex regional hubs that buy
                    waste cheaply and produce multiple highly sought after fuels
                    and carbon products.
                  </p>
                ...
                <div className="lg:col-span-5 bg-primary text-white rounded-[2.5rem] p-10 shadow-ambient relative overflow-hidden flex flex-col justify-between h-full">
                    ...
                    <div className="space-y-4 text-xs font-body">
                      ...
                      <div className="flex gap-4 items-start">
                        ...
                        <div>
                          ...
                          <p className="text-white/70 mt-0.5">
                            Licensing IP blueprints and modular designs to
                  ...
                  <div className="border-t border-white/10 pt-6 mt-8">
                    <a
                      href="mailto:investors@ratnanjalibioenergy.com"
                      className="btn-primary w-full justify-center text-xs uppercase tracking-widest py-3.5"
                    >
            ...
            <div className="intent-reveal space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-outline-variant/30 rounded-[2rem] p-8 shadow-ambient-sm flex flex-col justify-between">
                  <div>
                    <span className="text-[10px] font-body font-semibold uppercase tracking-widest text-surface-tint block mb-4">
                      Tier 01
                    </span>
                    ...
                    <p className="font-body text-xs text-on-surface-variant leading-relaxed">
                      Farmers, agricultural cooperatives, and timber companies
                      within a 50km processing radius. Sourcing straw, rice
                      husks, wood chips, and organic residues.
                    </p>
                  </div>
                ...
                <div className="bg-white border border-outline-variant/30 rounded-[2rem] p-8 shadow-ambient-sm flex flex-col justify-between">
                  <div>
                    ...
                    <p className="font-body text-xs text-on-surface-variant leading-relaxed">
                      Industrial heat users, cement plants, municipal utilities,
                      organic fertilizer companies, and corporate carbon offset
                      purchasers seeking stable biocarbon supply.
                    </p>
                  </div>
                  <div className="border-t border-outline-variant/20 pt-6 mt-6">
                    <a
                ...
                <div className="bg-white border border-outline-variant/30 rounded-[2rem] p-8 shadow-ambient-sm flex flex-col justify-between">
                  <div>
                    ...
                    <p className="font-body text-xs text-on-surface-variant leading-relaxed">
                      Research universities, material laboratories, and
                      engineering consultants looking to test advanced carbon
                      coatings, composite matrices, and synthetic batteries.
                    </p>
                  </div>
                  <div className="border-t border-outline-variant/20 pt-6 mt-6">
                    <a
