...
export default function ContactInterface() {
  ...
  return (
    <section
      id="interface"
      ref={containerRef}
      className="py-20 bg-surface-container-low border-t border-outline-variant/30"
    >
        ...
        <div className="contact-interface-reveal grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            {formSubmitted ? (
              <div className="text-center py-20 flex-grow flex flex-col justify-center items-center">
                ...
                <p className="font-body text-sm text-on-surface-variant leading-relaxed max-w-sm">
                  Your inquiry has been successfully routed. Our functional team
                  will reach out within our target SLA windows.
                </p>
                <button
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            ...
            <div className="bg-white border border-outline-variant/35 rounded-[2rem] p-8 shadow-ambient-sm relative overflow-hidden">
              ...
              <h4 className="font-heading text-2xl text-primary font-normal mb-4">
                Ratnanjali Bioenergy Headquarters
              </h4>

              <div className="space-y-4 text-xs font-body text-on-surface-variant leading-relaxed">
                <p>
                  12, Mahatma Gandhi Road, Halasuru,
                  <br />
            ...
            <div className="bg-white border border-outline-variant/35 rounded-[2rem] p-8 shadow-ambient-sm flex-grow flex flex-col justify-between">
              <div>
                <span className="text-[9px] font-body font-bold text-surface-tint uppercase tracking-widest block mb-4">
                  Regional Nodes
                </span>
                <h4 className="font-heading text-2xl text-primary font-normal mb-6">
                  Preprocessing Grid
                </h4>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-surface-container-low/50 rounded-xl p-3 border border-outline-variant/20">
                    <div>
                      <strong className="block text-xs text-primary font-heading font-normal">
                        Mandya Node (Active)
                      </strong>
                      <span className="block text-[10px] text-on-surface-variant/70 font-body">
                        Residue: Sugarcane Bagasse & Straw
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2.5 h-2.5 rounded-full bg-verdaez-400 animate-pulse" />
                      <span className="text-[9px] font-body font-bold text-verdaez-500 uppercase">
                        ONLINE
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center bg-surface-container-low/50 rounded-xl p-3 border border-outline-variant/20">
                    <div>
                      <strong className="block text-xs text-primary font-heading font-normal">
                        Tumakuru Node (Active)
                      </strong>
                      <span className="block text-[10px] text-on-surface-variant/70 font-body">
                        Residue: Coconut Husks & Offcuts
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2.5 h-2.5 rounded-full bg-verdaez-400 animate-pulse" />
                  ...
                  <div className="flex justify-between items-center bg-surface-container-low/50 rounded-xl p-3 border border-outline-variant/20">
                    <div>
                      <strong className="block text-xs text-primary font-heading font-normal">
                        Davanagere Node (Planned)
                      </strong>
                      <span className="block text-[10px] text-on-surface-variant/70 font-body">
                        Residue: Rice Husks & Maize Straw
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2.5 h-2.5 rounded-full bg-amber-400" />
                      <span className="text-[9px] font-body font-bold text-amber-600 uppercase font-semibold">
                        STAGED
                      </span>
                    </div>
                  </div>
