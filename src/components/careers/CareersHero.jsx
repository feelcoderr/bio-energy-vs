...
export default function CareersHero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[75vh] flex items-center bg-surface-container-lowest pt-28 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="careers-reveal font-heading text-5xl md:text-6xl lg:text-7xl text-primary font-normal leading-[1.1] mb-6">
            Work on the Frontlines of the <br/>
          ...
          <p className="careers-reveal font-body text-base md:text-lg text-on-surface-variant leading-relaxed max-w-2xl mb-8">
            Verdaez is scaling physical carbon solutions to mitigate industrial emissions and restore soils. We are looking for engineers, operators, and builders who prioritize physical execution over slides.
          </p>
