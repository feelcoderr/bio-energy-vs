...
const cultureValues = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h2.945M11 20.935V19a2 2 0 012-2h1.5a2.5 2.5 0 002.5-2.5V14a2 2 0 00-2-2h-1.5a2 2 0 01-2-2V7.5A2.5 2.5 0 0010.5 5h-.5a2 2 0 01-2-2V3m13 9a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    )
  },
  {
...
export default function CareersCulture() {
  ...
  return (
    <section id="culture" ref={containerRef} className="py-32 bg-surface-container-low border-t border-outline-variant/30 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="culture-reveal text-center mb-20 max-w-3xl mx-auto">
          ...
          <p className="font-body text-base md:text-lg text-on-surface-variant leading-relaxed">
            Verdaez is an engineering-first culture. We combine strict physical science with commercial realism to solve carbon circularity.
          </p>
        </div>
          ...
          {cultureValues.map((value) => (
            ...
            >
              ...
              <div className="border-t border-outline-variant/20 pt-6 mt-6 flex justify-between items-center text-[9px] font-body font-bold text-on-surface-variant/40 tracking-widest uppercase">
                ...
                <span className="text-surface-tint">VERDAEZ PLATFORM</span>
              </div>
            </div>
          ))}
        </div>
